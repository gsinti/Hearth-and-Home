...
namespace Server.Items
{
	...
	{
		public override string DefaultDescription{ get{ return "Kindling can be used by proficient campers to make a campfire. Campfires can be used by adventurers to recover health and stamina much quicker. There cannot be any enemies nearby for anyone to benefit from the effects."; } }
