...
namespace Server.Items
{
	...
	{
		public override string DefaultDescription{ get{ return "Campfires can be used by adventurers to recover health and stamina much quicker. There cannot be any enemies nearby for anyone to benefit from the effects."; } }
